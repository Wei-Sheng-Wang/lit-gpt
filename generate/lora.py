...
def main(
    ...
    input: str = "",
    lora_path: Path = Path("out/lora0/lit_model_lora_finetuned_rank8_6k_best.pth"),
    ...
    torch.save(base_model_dict, "/workspace/lora-merged-weights-6k-best.pth")
    return
    model = fabric.setup(model)

    tokenizer = Tokenizer(checkpoint_dir)
    from tqdm import tqdm
    with open("/workspace/data2/test.json", "r") as file:
